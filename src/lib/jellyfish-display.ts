...
const compact:Record<JellyfishObservationStatus,string>={no_recent_reports:"Sin reportes",recent_sighting:"Avistado",multiple_recent_sightings:"Varios",strong_recent_presence:"Destacable",recent_no_sightings:"Reporte sin avist.",unknown:"Sin info."};
